...
export default function Sidebar() {
  ...
  // Estilo ATIVO: Fundo vermelho com texto branco para destacar bem
 const activeStyle =
  "bg-gradient-to-r from-red-700 to-red-600 text-white font-bold shadow-lg shadow-red-900/40 border-l-4 border-red-500";
  // Estilo INATIVO: Texto branco que vira vermelho no hover
  const inactiveStyle =   "text-gray-400 hover:text-white hover:bg-zinc-900/80";
  ...
  return (
    <aside className="w-64 bg-black text-white h-full p-6 flex flex-col">
      {/* Logo com destaque em vermelho conforme aprovado */}
  ...
  <span className="mt-3 text-red-600 font-bold text-xl tracking-wide">
    RMP Motorsport
      ...
      <div className="mt-auto pt-6 border-t border-zinc-800">
        <button className="text-sm text-gray-400 hover:text-red-500 flex items-center gap-2 transition">
